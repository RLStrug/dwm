...
static const char *musicplaycmd[]   = { "mpc", "toggle", NULL };
static const char *musicpausecmd[]  = { "mpc", "pause", NULL };
static const char *musiccdprevcmd[] = { "mpc", "cdprev", NULL };
...
static Key keys[] = {
	...
	{ 0,            XF86XK_AudioPause,         spawn,          {.v = musicpausecmd} },
	{ 0,            XF86XK_AudioPrev,          spawn,          {.v = musiccdprevcmd} },
